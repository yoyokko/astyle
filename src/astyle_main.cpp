...
void ASConsole::printHelp() const
{
	...
	cout << "    method prefix.\n";
	cout << endl;
	cout << "    --pad-method-brackets  OR  -xB\n";
	cout << "    Insert space padding after the ')' Objective-C\n";
	cout << "    method return type or arguments.\n";
	cout << endl;
...
void ASOptions::parseOption(const string &arg, const string &errorInfo)
{
	...
	else if ( isOption(arg, "xB", "pad-method-brackets") )
	{
		formatter.setMethodBracketsPaddingMode(true);
	}
